                                ...
                                <div className="content_end">
                                    <div className="content_end_left">
                                        ...
                                        <ul className="content_end_left_list">
                                            ...
                                            <li>
                                                <AiOutlineCheck/> <strong>Online payment is possible</strong>{' '}
                                                – via the Walknjoy
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            {element?.percent === 0 ? (
                                                ...
                                                <>
                                                    <del>
                                                        AZN{' '}
                                                        {(
                                                            (element?.price * nightCount * guests * rooms * element?.percent) / 100).toFixed(2)}
                                                    </del>
                                                    <br/>
                                                    <span>AZN {(
                                                        element?.price * nightCount * guests * rooms -
                                                        ((element?.price * nightCount * guests * rooms * element?.percent) / 100)
