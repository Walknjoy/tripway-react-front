                ...
                <div className="content_end">
                  <div className="content_end_left">
                    ...
                    <ul className="content_end_left_list">
                      ...
                      <li>
                        <AiOutlineCheck /> <strong>No prepayment needed</strong>{' '}
                        – pay at the property
                      </li>
                      <li>Only 1 room left at this price on our site</li>
                    </ul>
                  </div>
                  <div className="content_end_right">
                    ...
                    <div className="price_area">
                      {element?.percent === 0 ? null : (
                        <del>
                          AZN{' '}
                          {Number(element?.price) -
                            (element?.price * element?.percent) / 100}
                        </del>
                      )}
                      <span>AZN {element.price}</span>
                    </div>
